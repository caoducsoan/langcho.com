            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img">
                        <img src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>" class="fh5co_img_special_relative"/></div>
                    <div class="fh5co_latest_trading_img_position_absolute"></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="text-white"> <?php echo htmlentities($row['posttitle']);?> </a>
                        <div class="fh5co_latest_trading_date_and_name_color"> <?php echo htmlentities($row['postingdate']);?></div>
                    </div>
                </div>
            </div>
            <?php } ?>
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4"><?php echo htmlentities($row['CategoryName'])?></div>
        </div>
         ...
         ?>
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="admin/postimages/<?php echo htmlentities($row1['PostImage']);?>" alt="<?php echo htmlentities($row1['PostTitle']);?>"/></div>
                    <div>
                        <a href="news-details.php?nid=<?php echo htmlentities($row1['id'])?>" class="d-block fh5co_small_post_heading"><span class=""><?php echo htmlentities($row1['PostTitle']);?></span></a>
                    </div>
                </div>
            </div>
            <?php } ?>
